...
- [x] 4.3 Executar lint dos artefatos OpenSpec alterados:
...
- Evidência da task 4.3:
  - `markdownlint-cli2 "openspec/changes/dashboard-search-result-totals/*.md" "openspec/changes/dashboard-search-result-totals/specs/**/*.md"` -> `0 error(s)`.
