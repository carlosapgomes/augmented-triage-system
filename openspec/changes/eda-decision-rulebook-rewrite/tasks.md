...
- [ ] 3.1 Update recommendation synthesis/reconciliation so the persisted recommendation reflects the rewritten rulebook instead of the legacy operational-vs-non-operational split.
