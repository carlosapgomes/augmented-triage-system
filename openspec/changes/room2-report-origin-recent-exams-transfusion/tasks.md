...
- [ ] 1.1 (Slice vertical) Criar testes de validação para novos campos de origem, transfusão binária e exames rastreados com recência em `tests/unit/test_llm1_validation.py`.
