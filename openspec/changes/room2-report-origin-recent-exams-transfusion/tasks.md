...
- [x] 4.2 (Slice vertical) Implementar renderização dos exames rastreados no template Room-2, com regra de empate por última ocorrência textual.
...
- [x] 5.2 (Slice vertical) Atualizar `src/triage_automation/infrastructure/llm/deterministic_client.py` para gerar payloads com origem, transfusão e exames rastreados.
