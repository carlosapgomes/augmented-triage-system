# Prompt mestre para execução sequencial (master + handoff do slice)

Use este prompt no glm-5.1 e substitua apenas os campos de slice.
...
1) AGENTS.md
2) openspec/changes/room2-report-origin-recent-exams-transfusion/handoffs/MASTER_PROMPT.md
3) openspec/changes/room2-report-origin-recent-exams-transfusion/handoffs/<ARQUIVO_DO_SLICE>.md
4) openspec/changes/room2-report-origin-recent-exams-transfusion/tasks.md
...
- Slice alvo: <EX.: 1.1>
- Handoff do slice: openspec/changes/room2-report-origin-recent-exams-transfusion/handoffs/<ARQUIVO_DO_SLICE>.md
...
Arquivo: /tmp/openspec-slice-report-<SLICE>.md
Deve conter:
- objetivo do slice
- arquivos alterados
...
1. Escolha o handoff do slice, por exemplo:
   - `openspec/changes/room2-report-origin-recent-exams-transfusion/handoffs/1.1-llm1-validation-tests.md`
2. No prompt acima, preencha:
   - `<ARQUIVO_DO_SLICE>` = `1.1-llm1-validation-tests.md`
   - `<SLICE>` = `1.1`
3. Envie o prompt para o glm-5.1.
