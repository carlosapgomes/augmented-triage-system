...
cases = sa.Table(
    ...
    sa.Column("room1_origin_room_id", sa.Text(), nullable=True),
    sa.Column("room1_origin_event_id", sa.Text(), nullable=True),
    sa.Column("room1_sender_user_id", sa.Text(), nullable=True),
    sa.Column(
        "web_pdf_filename",
        sa.Text(),
        nullable=True,
